...
- Configure debug output in webview: Debug Service dropdown → "Developer Tools Console"
- Check VS Code Developer Console for extension logs (Help → Toggle Developer Tools)
